    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          >
            {/* By{' '}Kathan Mehta */}
            <span className="hover:text-blue-500 dark:hover:text-blue-300">By Kathan Mehta</span> 
...
{/* <Image className="h-auto max-w-lg transition-all duration-300 rounded-lg blur-sm hover:blur-none" src="/next.svg" alt="image description"  width={180}
      ...
      <div className="mt-4 mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols lg:text-left">
        ...
        >
          <h2 className={`mb-3 text-2xl font-semibold`}>
            ...
            <form>   
                <label htmlFor="default-search" className="mb-2 mt-4 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
      ...
      />
                    ...
                    <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mt-10" placeholder="Paste the group member link here" required />
          ...
          <p className={`m-0 max-w-[50ch] text-lg opacity-50`}>
            Paste the Link and Click Search to start sending DMs to first 100 members of that group
          </p>
        </a>
      </div>
      ...
      <div className="mt-10 grid grid-cols-2 gap-2">
        <div>
            <Image className="h-auto max-w-full rounded-lg" src="/ss1.png" width={380} height={157} alt="" />
        </div>
        <div>
            <Image className="h-auto max-w-full rounded-lg" src="/ss2.png" width={480} height={157} alt="" />
        </div>
    ...
    <div>
            <Image className="mt-10 h-auto max-w-full rounded-lg" src="/ss3.png" width={580} height={50} alt="" />
        </div>
        </div>
